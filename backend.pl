...
consulta2([H|T], P, Hor, X) :-
    ...
    % BUSCA UN DIA LIBRE, YA SEA TODA LA MA�ANA O TARDE
    ...
    % A�ADE AL HORARIO Y SIGUE BUSCANDO
...
% HORARIOS DE LA MA�ANA Y TARDE CURSOS DE 1 CLASE A LA SEMANA
gen2([H|T], P, A, Hor, X) :-
...
% HORARIOS DE LA MA�ANA Y TARDE CURSOS DE 2 CLASES A LA SEMANA
gen2([H|T], P, A, Hor, X) :-
    % BUSCA EL CURSO Y QUE PROFESORES LO DAN
